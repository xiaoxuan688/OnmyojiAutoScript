...
class OrochiAssets:
	...
	# 野队挑战
	I_OROCHI_WILD_FIRE = RuleImage(roi_front=(1010,577,133,55), roi_back=(991,557,166,111), threshold=0.8, method="Template matching", file="./tasks/Orochi/o/o_orochi_wild_fire.png")
	...
	# 御魂界面右上角突破卷数量
	O_REALM_RAID_NUMBER = RuleOcr(roi=(936,10,82,36), area=(936,10,82,36), mode="DigitCounter", method="Default", keyword="", name="realm_raid_number_orochi")
